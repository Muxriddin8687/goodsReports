...
@Component({
  selector: 'app-arriv',
  templateUrl: './arriv.component.html',
  styleUrls: ['./arriv.component.scss']
})
export class ArrivComponent {
  ...
  save() {
    let data = this.formList.value.data.filter((item: any) => item.count != 0);
